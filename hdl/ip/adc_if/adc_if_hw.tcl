...
# +-----------------------------------
# | 
# | adc_if "ADC Interface" v1.0
# | alexh 2012.03.10.23:26:48
# | 
# | 
# | /home/alex/socp-test/next/hwtest/hdl/ip/adc_if/adc_if.v
# | 
# |    ./adc_if.v syn, sim
# | 
# +-----------------------------------
...
# | module adc_if
# | 
set_module_property NAME adc_if
set_module_property VERSION 1.0
set_module_property INTERNAL false
set_module_property OPAQUE_ADDRESS_MAP true
set_module_property AUTHOR alexh
set_module_property DISPLAY_NAME "ADC Interface"
set_module_property TOP_LEVEL_HDL_FILE adc_if.v
set_module_property TOP_LEVEL_HDL_MODULE adc_if
set_module_property INSTANTIATE_IN_SYSTEM_MODULE true
set_module_property EDITABLE true
set_module_property ANALYZE_HDL TRUE
set_module_property STATIC_TOP_LEVEL_MODULE_NAME adc_if
...
# | files
# | 
add_file adc_if.v {SYNTHESIS SIMULATION}
# | 
# +-----------------------------------
...
add_parameter NREGS INTEGER 16
set_parameter_property NREGS DEFAULT_VALUE 16
...
# +-----------------------------------
# | connection point adc_if_conduit
# | 
add_interface adc_conduit conduit end

set_interface_property adc_conduit ENABLED true

add_interface_port adc_conduit done export Input 1
add_interface_port adc_conduit enable export Output 1
add_interface_port adc_conduit busy export Output 1
# | 
# +-----------------------------------
