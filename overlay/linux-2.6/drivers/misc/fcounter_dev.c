...
#define FCOUNTER_IRQ_REG	(0x04 << 2)
#define FCOUNTER_MAGIC_REG	(0x05 << 2)
#define FCOUNTER_INPUT_SEL_REG	(0x00 << 2)
#define FCOUNTER_CYCLECOUNT_REG	(0x03 << 2)
#define FCOUNTER_EDGECOUNT_REG	(0x02 << 2)

#define FCOUNTER_ENABLE_REG	(0x0A << 2)
